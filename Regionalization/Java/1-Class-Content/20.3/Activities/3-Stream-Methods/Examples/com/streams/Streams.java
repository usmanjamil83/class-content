...
class Streams {
  ...
  public static void main (String[] args) {
    ...
    System.out.println(
        String.format("There are %d dooctors whose names don't start with A.",
    ...
    integers.forEach((Integer _int) -> System.out.println(_int));
  ...
  private static double _avearge (final double... terms) {
