# Week 20 Homework - Creating a Meal Tracker Backend
...
You don't have to save a `MealTime`—it's just logical to do so. If you'd like Sto implement this, read about Java's [Date and Time Classes](https://docs.oracle.com/javase/tutorial/datetime/iso/datetime.html), or use [Joda-Time](www.joda.org/joda-time/quickstart.htm).
...
You're free to add additional categories (dessert, etc.).
...
Finally, you should test your applicatoin in a `Test` class, just to make sure everything works correctly. If you'd like an extra-credit challenge, use [JUnit](http://junit.org/junit4) to unit-test your code.
